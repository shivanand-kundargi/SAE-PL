...
def extend_cfg(cfg):
    ...
    # SAE integration config
    cfg.TRAINER.MAPLE.USE_SAE = False  # enable SAE concept-guided prompts
    cfg.TRAINER.MAPLE.SAE_PATH = ""  # path to pretrained SAE checkpoint
    cfg.TRAINER.MAPLE.SAE_LAYER = -2  # ViT layer to hook for SAE activations (default: second-to-last)
    cfg.TRAINER.MAPLE.SAE_HIDDEN_DIM = 256  # hidden dimension of SAE projection MLP
    cfg.TRAINER.MAPLE.SAE_ALIGN_WEIGHT = 0.1  # weight for cosine alignment loss
